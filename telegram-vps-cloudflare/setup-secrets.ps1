...
try {
    ...
    $commands = @(
        ...
        @{ command = 'latency'; description = '测试当前设备到 VPS 的延迟' },
        @{ command = 'speedtest'; description = '测试当前设备从 VPS 下载网速' },
        @{ command = 'testsetup'; description = '安全启用本地直连测试入口' },
        @{ command = 'testdisable'; description = '安全停用本地直连测试入口' },
