/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: fca3f37f52582cb7256eb252c767db64)
// Runtime types generated with workerd@1.20260811.1 2026-08-13 nodejs_compa
interface __BaseEnv_Env {
	TelegramVpsAgent: DurableObjectNamespace<import("./src/index").TelegramVpsAgent>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "TelegramVpsAgent";
	}
...
interface Hyperdrive {
     ...
     * your database. This is provided for database drivers that require the hos
...
declare namespace CloudflareWorkersModule {
    ...
    // lost when the caller supplies an explicit return-type argument). No
    ...
    export abstract class WorkflowStep {
        ...
        // so the callback context reflects whether the resolved delay is presen
